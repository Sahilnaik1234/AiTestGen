...
describe('MathService', () => {
    ...
    describe('add', () => {
        it('should add two positive numbers', () => {
            expect(mathService.add(10, 2)).toBe(12);
            expect(mathService.add(20, 10)).toBe(30);
        });
        ...
        it('should add a positive and a negative number', () => {
            expect(mathService.add(10, -2)).toBe(8);
            expect(mathService.add(-10, 2)).toBe(-8);
        });
    ...
    describe('multiply', () => {
        it('should multiply two positive numbers', () => {
            expect(mathService.multiply(10, 2)).toBe(20);
            expect(mathService.multiply(20, 10)).toBe(200);
        });
