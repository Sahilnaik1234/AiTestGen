...
describe('dateUtils', () => {
    ...
    describe('convertToTimezone', () => {
        it('should convert to timezone correctly', () => {
            const date = new Date('2022-01-01');
            const result = dateUtils.convertToTimezone(date, 'UTC');
        ...
        it('should handle different timezones', () => {
            ...
            // Note: This test case may fail due to the system's timezone settings.
    ...
    describe('getQuarter', () => {
        ...
        it('should handle dates in different quarters', () => {
            ...
            expect(dateUtils.getQuarter(date)).toBe(3);
            const date2 = new Date('2022-10-01');
            expect(dateUtils.getQuarter(date2)).toBe(4);
        });
    });
