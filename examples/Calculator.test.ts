...
describe('Calculator', () => {
    ...
    describe('Scientific Functions', () => {
        ...
        it('should throw an error when calculating the square root of a negative number', () => {
            expect(() => calculator.sqrt(-1)).toThrowError('Negative square root');
        });
    ...
    describe('Statistics', () => {
        ...
        it('should throw an error when calculating the factorial of a negative number', () => {
            expect(() => calculator.factorial(-1)).toThrowError('Factorial of negative number');
        });
    });

    // Advanced Formulas
    describe('Advanced Formulas', () => {
        it('should calculate the Fibonacci sequence', () => {
            expect(calculator.fibonacci(10)).toBe(55);
        });

        it('should throw an error when calculating the Fibonacci sequence of a negative number', () => {
            expect(() => calculator.fibonacci(-1)).toThrowError('Fibonacci of negative number');
        });
    ...
    describe('Financial Calculations', () => {
        it('should calculate the compound interest', () => {
            expect(calculator.compoundInterest(1000, 0.05, 5, 1)).toBeCloseTo(1276.28);
        });
        ...
        it('should calculate the future value', () => {
            expect(calculator.futureValue(1000, 0.05, 5)).toBeCloseTo(1276.28);
        });
    });
    ...
    describe('Geometric Calculations', () => {
        ...
        it('should calculate the area of a rectangle', () => {
            expect(calculator.rectangleArea(5, 10)).toBe(50);
        });

        it('should calculate the area of a triangle', () => {
            expect(calculator.triangleArea(5, 10)).toBe(25);
        });
